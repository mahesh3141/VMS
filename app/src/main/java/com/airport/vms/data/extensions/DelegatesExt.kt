package com.airport.vms.data.extensions
...
object DelegatesExt {
    ...
    fun clearPrefs() = VMS.ctx.getSharedPreferences("default", Context.MODE_PRIVATE).edit().clear().commit()
...
fun logCrashlytics(throwable: Throwable) {
    if (BuildConfig.DEBUG)
